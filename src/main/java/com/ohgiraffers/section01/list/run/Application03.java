...
public class Application03 {
    public static void main(String[] args) {
        ...
        *  후입선출(LIF0 - LastIn First Out) 방식의 자료구조이다.
        *  */


        Stack<Integer>integerStack = new Stack<>();

        /*필기. 값을 넣을 떄는 push() 메소드를 이용한다. add() 도 가능하다. */
        ...
        /*필기.
        *  Stack 에서 요소를 찾을 때 search() 를 이요할 수 있다.
        ...
        * */
        ...
        /*필기.
        *   peak() : 해당 스택의 가장 마지막에 있는(상단) 요소 반환
        ...
        * */
        ...
        System.out.println("peak() : " + integerStack.pop());
        System.out.println("integerStack = " + integerStack);
